...
public class escribirFicheros {
    ...
    public static void exportarCarnetXML(Entrenador entrenador){
            try {
                ...
                idElement.appendChild(document.createTextNode(String.valueOf(entrenador.getCarnet().getIdEntrenador())));
                root.appendChild(idElement);

                // Crear nodo <fechaexp>
                Element fechaExpElement = document.createElement("fechaexp");
                fechaExpElement.appendChild(document.createTextNode(entrenador.getCarnet().getFechaExpedicion().toString()));
                ...
                puntosElement.appendChild(document.createTextNode(String.format("%.2f", entrenador.getCarnet().getPuntos())));
